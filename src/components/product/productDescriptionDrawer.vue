<template>
    <div class="lose-product-drawer">
        ...
        <div class="drawer" :class="{show: active}">
            ...
            <div v-if="product" class="prduct-details">
                ...
                <div class="button_container">
                    <button class="remove" @click="removeFromeCart()">Remove</button>
...
export default {
    ...
    methods: {
         ...
         removeFromeCart(){
             this.$store.commit('removeFromeCart',this.product)
         }
    },
    computed:{
        product_total(){
